...
//    ArrayList<GameProgress> savedData = new ArrayList<>(Arrays.asList( gameProgress1, gameProgress2, gameProgress3));
// откроем выходной поток для записи в файл
        ...
        saveGame("C:\\Users\\Ольга\\IdeaProjects\\java core\\1.3files-directories\\Games\\savegames\\save2.dat", gameProgress1);
        saveGame("C:\\Users\\Ольга\\IdeaProjects\\java core\\1.3files-directories\\Games\\savegames\\save3.dat", gameProgress1);
